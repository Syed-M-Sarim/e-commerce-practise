...
function createElement(price,title,category){
  var ele = `<div><div class="p-4 md:w-1/3">
        <div class="h-full border-2 border-gray-800 rounded-lg overflow-hidden">
          ...
          <div class="p-6">
            ...
            <h1 class="title-font text-lg font-medium text-white mb-3">${title} ${price}</h1>
...
function renderProducts (){
  ...
  products.forEach((data,ind)=>{
    var ele == createElement(data.title , data.price , data.category , data.image , data.description);
